...
public class Main {
    public static void main(String[] args) {
        // Instanciando o Scanner que vai ler os inputs
        Scanner read = new Scanner(System.in);

        double posicaoInicialA = 0,
                posicaoInicailB = 0,
                velocidadeA = 0,
                velocidadeB = 0,
                converterParNegativo = -1;
        ...
        // loop para rodar novamente
        do{
            // loop que se encerra se todos os inputs forem preenchidos
            while(true){
                try{
                    ...
                    if (posicaoInicialA >=0 && posicaoInicialA <=10000){
                        ...
                        //loops que forçam o usuário a inserir o valor correto
                        do{
                            try{
                                correto = false;
